    ...
    <div className="container-fluid">
      ...
      <div className=" row justify-content-center mt-4">
        ...
        <div className="row col-md-8 col-sm-12 justify-content-center">
          ...
          <a className="ml-3 text-dark" href="https://drive.google.com/file/d/1zN-ZbW7oobOc0IZ8jy0RxzUouS78E3mI/view?usp=sharing" target="blank"><button className="btn btn-lg btn-outline-info"> Download Resume</button></a>
        </div>
        <div className="col-md-2 col-sm-0">
              ...
              <div className="col-lg-4 col-md-6 col-sm-12 mb-5">
                  <div className="card  shadow-lg">
                    <div className="card-body ">
                      ...
                      <a class="card-link text-muted mt-5" href="https://github.com/krsnaapoorv/projects/tree/master/masai-sprint-2" target="blank">
                        <i class="fab fa-github"></i><strong>Github</strong>
                      </a>
                      <a class="card-link text-muted mt-5" href="https://manage-expense.netlify.com/" target="blank">
              ...
              <div className="col-lg-4 col-md-6 col-sm-12 mb-1">
                  <div className="card  shadow-lg pb-1">
                    <div className="card-body ">
                      ...
                      <a class="card-link text-muted mt-5" href="https://github.com/masai-school/cohort_3/tree/master/submissions/sm_103_apoorva/week_08/day_3/assignment" target="blank">
                        <i class="fab fa-github"></i><strong>Github</strong>
                      </a>
                      <a class="card-link text-muted mt-5" href="https://stopwatchtimer.netlify.com/" target="blank">
                        <i class="fab fa-external-link-square-alt"></i><strong>Demo Link</strong>
                      </a>
                    </div>
              ...
              <div className="col-lg-4 col-md-6 col-sm-12 mb-1">
                  <div className="card  shadow-lg">
                    <div className="card-body ">
                      ...
                      <a class="card-link text-muted mt-5" href="https://github.com/masai-school/cohort_3/tree/master/submissions/sm_103_apoorva/week_09/day_5" target="blank">
                        <i class="fab fa-github"></i><strong>Github</strong>
                      </a>
                      <a class="card-link text-muted mt-5" href="https://microsoft-dummy1.netlify.com/" target="blank">
                        <i class="fab fa-external-link-square-alt"></i><strong>Demo Link</strong>
                      </a>
                    </div>
              ...
              <div className="col-lg-4 col-md-6 col-sm-12 mb-1">
                  <div className="card  shadow-lg pb-3">
                    <div className="card-body ">
                      ...
                      <hr></hr>
                      <h2 class="card-title font-weight-bold">Teachers Manager</h2>
                      <h5 class="card-text">
              ...
              <div className="col-lg-4 col-md-6 col-sm-12">
                  <div className="card  shadow-lg pb-1">
                    <div className="card-body ">
                      ...
                      <hr></hr>
                      <h2 class="card-title font-weight-bold">Blog Application</h2>
                      <h5 class="card-text">
                        A blog application where you can see blog written by different users and comment on that.You can also add,edit,delete your blog.
                      </h5>
                      <a class="card-link text-muted mt-5" href="https://github.com/masai-school/cohort_3/tree/master/submissions/sm_103_apoorva/week_18/day_4/sesssion_1" target="blank">
                        <i class="fab fa-github"></i><strong>Github</strong>
                      </a>
                    </div>
      ...
      <div className="row justify-content-center">
        <div>
          <div className="circleDiv ml-2 mt-sm-2 d-flex justify-content-center ">
        ...
        <div>
          <div className="circleDiv ml-4 mt-sm-2 d-flex justify-content-center ">
            <h2 className="text-center m-auto font-weight-bold">240+</h2>
          </div>
          <h4 className="text-center text-muted m-auto font-weight-bold p-4">Hackerrank Problems</h4>
        </div>
        
        <div>
          <div className="circleDiv ml-3 mt-sm-2 d-flex justify-content-center ">
            <h2 className="text-center m-auto font-weight-bold">100</h2>
          </div>
        ...
        <div>
          <div className="circleDiv ml-3 mt-sm-2 d-flex justify-content-center ">
            <h2 className="text-center m-auto font-weight-bold">290+</h2>
          </div>
          <h4 className="text-center text-muted m-auto font-weight-bold p-4">Git Commits</h4>
        </div>
